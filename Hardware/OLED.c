...
/**
 ...
 void OLED_I2C_SendByte(uint8_t Byte) {
    HAL_I2C_Master_Transmit(&hi2c2, OLED_ADDRESS, &Byte, 1, HAL_MAX_DELAY);
}
...
/**
 ...
 void OLED_WriteCommand(uint8_t Command) {
    ...
    HAL_I2C_Master_Transmit(&hi2c2, OLED_ADDRESS, cmd_data, 2, HAL_MAX_DELAY);
}
...
/**
 ...
 void OLED_WriteData(uint8_t *Data, uint8_t Count) {
    ...
    HAL_I2C_Master_Transmit(&hi2c2, OLED_ADDRESS, buffer, Count + 1, HAL_MAX_DELAY);
}
